...
Route::middleware('auth')->group(function () {
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::delete('delete', [BankController::class, 'deleteAccount'])->name('delete');
        });
    });
    ...
    Route::group([
        ...
        Route::post('set-dimensions', [GridController::class, 'setDimensions'])
            ->middleware('permission:access_control_panel')->name('set-dimensions');
    ...
    Route::group([
        ...
        Route::group([
            ...
            Route::post('transfer-record-paginate', [AdminWalletController::class, 'transferRecordPaginate'])->name('transfer-record-paginate');
...
Route::get('{any?}', [IndexController::class, 'view'])
    ->where('any', '.*')->middleware('installer.redirect')->name('index');
