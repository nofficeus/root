...
class CoinFormatter
{
    ...
    {
        return convertCurrency($this->calcPrice($dollarPrice), 'USD', strtoupper($currency), $format);
    }
    ...
    {
        return convertCurrency($this->calcPrice($dollarPrice), 'USD', strtoupper($currency), true);
    }
}
